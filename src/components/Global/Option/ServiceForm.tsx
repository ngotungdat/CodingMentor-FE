					...
					<Form form={form} layout="vertical" onFinish={onSubmit}>
						<div className="row">
							<div className="col-12">
								...
								>
									<Input placeholder="" className="style-input" onChange={(e) => setValue('ServiceName', e.target.value)} />
								</Form.Item>
							</div>
						</div>
						{/*  */}
						<div className="row">
							<div className="col-12">
								<Form.Item label="Thông tin dịch vụ" name="DescribeService" initialValue={props.rowData?.DescribeService}>
									<TextArea placeholder="" rows={2} onChange={(e) => setValue('DescribeService', e.target.value)} />
								</Form.Item>
							</div>
						</div>
						<div className="row">
