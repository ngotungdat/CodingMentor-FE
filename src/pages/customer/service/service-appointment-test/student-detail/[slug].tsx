...
import { studentApi, areaApi, jobApi, puroseApi, branchApi, sourceInfomationApi, parentsApi, staffApi } from '~/apiBase'
...
const CustomerDetail = () => {
	...
	return isLoading ? (
		...
		dataRow && <StudentForm listDataForm={checkEmptyData && listDataForm} dataRow={dataRow} />
	)
}
