;(function () {
	...
	d.addWheelListeners = function () {
		d.wheelIsListened ||
			(d.isNN &&
				(window.addEventListener('DOMMouseScroll', d.handleWheel, { passive: !1, useCapture: !0 }),
			...
			for (k[g] = ''; h.length > b; k[g] += d.trim(h.slice(0, f)) + ((h = h.slice(f)).length ? c : ''))
				f =
					2 == e || (f = h.slice(0, b + 1).match(/\S*(\s)?$/))[1]
						? b
						: f.input.length - f[0].length || (1 == e && b) || f.input.length + (f = h.slice(b).match(/^\S*/))[0].length
			h = d.trim(h)
		}
		return k.join(c)
	}
		...
		if (b) {
			...
			for (l = 0; l < c.length; l++) {
				var m = c[l],
					n = b[m]
				void 0 !== n &&
					((n = f ? d.addPrefix(n, k, h, e) : d.formatNumber(n, e)), (a = a.replace(new RegExp('\\[\\[' + g + '' + m + '\\]\\]', 'g'), n)))
			}
		}
		return a
	}
	...
	d.AxisBase = d.Class({
		...
		positionTitle: function () {
			...
			if (a) {
				...
				0 < e.length()
					? (g = e.getBBox())
					: ((g.x = 0), (g.y = 0), (g.width = this.width), (g.height = this.height), d.VML && ((g.y += this.y), (g.x += this.x)))
				e.push(a)
				var e = g.x,
					f = g.y
			...
			if (0 < this.gridCountR)
				for (
					...
					'MM' == A &&
						((g = (p - l) / y),
						1.5 <= (p - l) / y &&
							((p = p - (g - 1) * y + d.getPeriodDuration('DD', 3)), (p = d.resetDateToMin(new Date(p), A, 1).getTime()), (C += y)))
	...
	d.ValueAxis = d.Class({
					...
					e
						...
						: (g &&
								...
								e[1]
									...
									: (f.precision = -1)),
						  (c = this.usePrefixes
								? d.addPrefix(a, h.prefixesOfBigNumbers, h.prefixesOfSmallNumbers, f, !b)
			...
			if (r && ('regular' == b || '100%' == b))
				for (q = 0; q < k.length; q++)
					(n = k[q]),
						(n.stackGraph = null),
						n.hidden ||
							((m = n.type), n.chart == this.chart && n.valueAxis == this && a == m && n.stackable && (l && (n.stackGraph = l), (l = n)))
			n = this.start - 10
			l = this.end + 10
					...
					if (((n = k[q]), n.hidden)) n.newStack && ((g[p] = NaN), (e[p] = NaN))
						...
						if (((m = this.data[p].axes[this.id].graphs[n.id]), (h = m.values.value), isNaN(h))) n.newStack && ((g[p] = NaN), (e[p] = NaN))
							...
							'regular' == b &&
								(r &&
									(isNaN(c[p])
										? ((c[p] = h), (m.values.close = h), (m.values.open = this.baseValue))
										: (isNaN(h) ? (m.values.close = c[p]) : (m.values.close = h + c[p]), (m.values.open = c[p]), (c[p] = m.values.close))),
								'column' == a &&
									(n.newStack && ((g[p] = NaN), (e[p] = NaN)),
									(m.values.close = h),
									0 > h
										? ((m.values.close = h),
										  isNaN(e[p]) ? (m.values.open = t) : ((m.values.close += e[p]), (m.values.open = e[p])),
										  (e[p] = m.values.close))
										: ((m.values.close = h),
										  isNaN(g[p]) ? (m.values.open = t) : ((m.values.close += g[p]), (m.values.open = g[p])),
										  (g[p] = m.values.close))))
						}
			}
						  ...
						  n.chart == this.chart &&
								...
								isNaN(h) ||
									...
									'100%' == b &&
										...
										isNaN(g[p]) && (g[p] = 0),
										0 > c
											? ((m.values.close = d.fitToBounds(c + e[p], -100, 100)), (m.values.open = e[p]), (e[p] = m.values.close))
											: ((m.values.close = d.fitToBounds(c + g[p], -100, 100)), (m.values.open = g[p]), (g[p] = m.values.close))))))
		},
		...
		coordinateToValue: function (a) {
			...
			return !0 === this.logarithmic
				? Math.pow(10, (d ? (!0 === e ? (b - a) / c : a / c) : !0 === e ? a / c : (b - a) / c) + Math.log(h) * Math.LOG10E)
				: !0 === e
				? d
					? f - (a - b) / c
					: a / c + f
		...
		getCoordinate: function (a, b) {
			...
			!0 === this.logarithmic
				? (0 === a && (a = this.treatZeroAs),
				  ...
				  (c = c ? (!0 === e ? d - f * h : f * h) : !0 === e ? f * h : d - f * h))
				: (c = !0 === e ? (c ? d - f * (a - h) : f * (a - h)) : c ? f * (a - h) : d - f * (a - h))
		...
		construct: function (a) {
			...
			'H' == a.orientation
				? ((e = d.line(p, [0, q], [0, 0], e, g, c)),
				  ...
				  'bottom' == a.position ? ((k = c / 2 + f + n + m - 1), (c = l)) : ((k = -c / 2 - f + m + k), (c = h + l)))
				: ((this.axisWidth = a.height),
				  'right' == a.position
						? ((e = d.line(p, [0, 0, -h], [0, n, n - k], e, g, c)), (k = m + k), (c = c / 2 + f + h + q + l - 1))
						: ((e = d.line(p, [0, 0], [0, n], e, g, c)), (k = m), (c = -c / 2 - f + l)))
			e.translate(c, k)
			c = b.container.set()
			c.push(e)
			b.axesSet.push(c)
...
;(function () {
	...
	d.RecItem = d.Class({
		construct: function (a, b, c, e, g, f, h, k, l, m, n, q) {
			...
			P &&
				'' !== c &&
				((ca = a.autoWrap && 0 === n ? d.wrappedText(z, c, w, t, r, ga, k, Math.abs(g), 0) : d.text(z, c, w, t, r, ga, k)),
				(ga = ca.getBBox()),
				(ha = ga.width),
				(Qa = ga.height))
			if ('H' == Pa) {
				if (
					...
					'bottom' == Z
						...
						: ((v += na + r / 2 - ea),
						  (G += ma),
						  J
								? (0 < n ? ((v = (ha / 2) * Math.sin(V) + B + 3), a.centerRotatedLabels || (G -= (ha / 2) * Math.cos(V))) : (v += B + 3),
								  (v += aa))
								: (0 < n
				...
				'right' == Z
					...
					: J
					? ((G += B + 4 - ea), f || (v -= r / 2 + 3), h && ((G += ma), (v += na)), (G += aa))
		...
		draw: function () {
			...
			if (a.drawGraphs) {
				...
				g ||
					...
					(g = 'top'),
					'column' == this.type && (a.rotate && (g = 'right'), '100%' == f || 'regular' == f) && (g = 'middle'),
		...
		createXYGraph: function () {
			...
			for (d = this.start; d <= this.end; d++) {
				...
				if (
					!isNaN(k) &&
					!isNaN(l) &&
					(a.push(h), b.push(m), (f.x = h), (f.y = m), (k = this.createBullet(f, h, m, d)), (l = this.labelText))
				) {
		...
		positionLabel: function (a, b, c, e, d) {
			if (e) {
				...
				switch (m) {
					...
					case 'inside':
						'column' == this.type &&
							((l = !0), q ? (p ? ((k = 'end'), (b = r - 3 - z)) : ((k = 'start'), (b = r + 3 + z))) : (c = p ? w + 7 + z : w - 10 - z))
						break
					case 'middle':
				...
				!this.showAllValueLabels &&
					t &&
					l &&
					((n = e.getBBox()), n.height > a.columnHeight || n.width > a.columnWidth) &&
					(e.remove(), (e = null))
				if (e && 'radar' != f.type)
					if (q) {
		...
		createSerialGraph: function () {
			...
			if (
				!(
					...
					(1 == e.length && 'step' != h && 'none' == this.bullet && ((this.bullet = 'round'), (this.resetBullet = !0)),
					(!Ra && void 0 == Ja) || m)
				)
			) {
				var Ua = Pa
			...
			for (L = P; L <= ia; L++) {
				...
				if (m && void 0 == this.openField)
					for (
						var yb = L + 1;
						yb < e.length && (!e[yb] || !(fb = e[L + 1].axes[f.id].graphs[b]) || !fb.values || ((Ta = fb.values.value), isNaN(Ta)));
						yb++
					);
				var S,
					R,
				...
				if (Ia) {
					...
					m &&
						(void 0 == this.openField
							? fb && ((fb.isNegative = Ta < W ? !0 : !1), isNaN(Ta) && (v.isNegative = !Sa))
					...
					Va = !1
					isNaN(W) ||
						(m ? (W > Ta ? (Sa && (Va = !0), (Sa = !1)) : (Sa || (Va = !0), (Sa = !0))) : (v.isNegative = W < Pa ? !0 : !1), (Ba = W))
					var Pb = !1
					...
					switch (h) {
						...
						case 'step':
							if (!isNaN(W)) {
								...
								if (Ob || v.gap)
									(A = y = NaN), (v.gap && 2 >= x.length) || this.drawLineGraph(x, u, T, U), (x = []), (u = []), (T = []), (U = [])
							} else if (!z) {
							...
							if (!isNaN(W)) {
								...
								if (!((W < Qb && rb < Qb) || (W > Rb && rb > Rb))) {
									...
									if (t) {
										...
										R < q &&
											0 < K &&
											((va = new d.Cuboid(g, ba, K, H - a.d3x, Q - a.d3y, Na, Wa, da, Ca, X, ga, w, t, ea, gb, pb, aa)),
								...
								if (t) {
									...
									if (R < q && 0 < K) {
										...
										!isNaN(sa) &&
											...
											F < q &&
											0 < F &&
											((Ya = d.line(g, Eb, [F, F], Ca, X, da)), (hb = d.line(g, Fb, [F, F], Ca, X, da)))
										ba = E - O
							...
							if ('regular' == M || '100%' == M) {
								...
								if (Zb) {
									...
									if (Oa) {
										...
										t
											? ((jb = Ea), (ib = 0 > W ? E - ac / 2 - 2 - kb - sb : E + ac / 2 + 3 + kb + sb))
											: ((ib = ya), (jb = 0 > W ? F + bc / 2 + kb + sb : F - bc / 2 - 3 - kb - sb))
										Oa.translate(ib, jb)
										f.totals[L] = Oa
			...
			if (1 < a.length) {
				...
				if (0 < h || 0 < A)
					if (
						...
						'serial' == q || 'radar' == q
							? 0 < c.length
								? (c.reverse(), e.reverse(), (p = a.concat(c)), (r = b.concat(e)))
								: 'radar' == q
								? (r.push(0), p.push(0))
								: g.rotate
								? (r.push(r[r.length - 1]), p.push(y), r.push(r[0]), p.push(y), r.push(r[0]), p.push(p[0]))
								: (p.push(p[p.length - 1]), r.push(y), p.push(p[0]), r.push(y), p.push(a[0]), r.push(r[0]))
							: 'xy' == q &&
							  (b = g.fillToAxis) &&
		...
		drawSmoothedGraph: function (a, b, c, e) {
			if (1 < a.length) {
				...
				0 < q &&
					...
					(p = ''),
					0 < c.length
						? (c.push('M'), e.push('M'), c.reverse(), e.reverse(), (n = a.concat(c)), (m = b.concat(e)))
						: (this.rotate
								? ((p += ' L' + x + ',' + b[b.length - 1]), (p += ' L' + x + ',' + b[0]))
								: ((p += ' L' + a[a.length - 1] + ',' + x), (p += ' L' + a[0] + ',' + x)),
						  (p += ' L' + a[0] + ',' + b[0])),
			...
			if (!isNaN(b) && !isNaN(c) && ('none' != this.bullet || this.customBullet || a.bullet || a.customBullet)) {
				...
				l &&
					...
					'function' == typeof l
						? ((l = new l()),
						  ...
						  (p = l.set))
						: ((p = g.set()), (l = g.image(l, 0, 0, h, h)), p.push(l), this.centerCustomBullets && l.translate(-h / 2, -h / 2)))
				if (p) {
					;(a.url || this.showHandOnHover) && p.setAttr('cursor', 'pointer')
					if ('serial' == e.type || 'gantt' == e.type)
						if (-0.5 > b || b > this.width || c < -h / 2 || c > this.height) p.remove(), (p = null)
				...
				if (p) {
					...
					if ((e = this.bulletHitAreaSize))
						(g = d.circle(g, e, '#FFFFFF', 0.001, 0)), g.translate(b, c), (a.hitBullet = g), this.bulletSet.push(g), this.addListeners(g, a)
					a.bulletGraphics = p
		...
		showGraphBalloon: function (a, b, c, e, g) {
			if (a) {
				var f = this.chart,
					...
					n = !0
				m
					? m.valueBalloonsEnabled || ((h = f.balloon), (k = this.x), (l = this.y), (n = !1))
						...
						? ((e = f.getBalloonColor(this, a)),
						  ...
						  isNaN(b) || isNaN(g)
								...
								: ((a = this.width),
								  ...
								  h.fixPrevious(),
								  h.fixedPosition && (c = !1),
								  !c && 'radar' != f.type && (b < k - 0.5 || b > a + k || g < l - 0.5 || g > q + l)
	...
	d.ChartCursor = d.Class({
		...
		hideCursor: function (a) {
			...
			;(this.chart.wasTouched && this.leaveAfterTouch) ||
				...
				this.leaveCursor ||
				(this.hideCursorReal(),
				a ? this.chart.handleCursorHide() : this.fire({ target: this, chart: this.chart, type: 'onHideCursor' }),
		...
		handleReleaseOutside: function () {
			...
			if (this.drawingNow) {
				...
				;(2 < Math.abs(a - c) || 2 < Math.abs(b - e)) &&
					this.fire({ type: 'draw', target: this, chart: g, initialX: a, initialY: b, finalX: c, finalY: e })
			}
			this.zooming &&
				((this.zooming = !1),
		...
		dispatchPanEvent: function () {
			if (this.mouseIsDown) {
				...
				isNaN(c) ||
					isNaN(e) ||
					(0 !== Math.abs(c) && 0 !== Math.abs(e) && (g = !0), this.prevDelta2X != c && this.prevDelta2Y != e) ||
					(g = !1)
				g &&
					(this.hideLines(),
					this.fire({ type: 'panning', chart: this.chart, target: this, deltaX: a, deltaY: b, delta2X: c, delta2Y: e, index: this.index }),
					(this.prevDeltaX = a),
					(this.prevDeltaY = b),
					(this.prevDelta2X = c),
					(this.prevDelta2Y = e))
		...
		draw: function () {
			...
			if (a.enabled) {
				...
				if ((a.height = h) && f) {
					...
					d.isAbsolute(k) && (h = '')
					c
						? ((l = h + k + 'H' + e.extension), (h = a.dragIconWidth), (c = a.dragIconHeight))
						: ((l = h + k + e.extension), (c = a.dragIconWidth), (h = a.dragIconHeight))
					k = b.image(l, 0, 0, c, h)
		...
		updateScrollbarSize: function (a, b) {
			if (!isNaN(a) && !isNaN(b)) {
				...
				var c = this.dragger,
					...
					k
				this.rotate
					? ((e = 0), (d = a), (f = this.width + 1), (h = b - a), c.setAttr('height', b - a), c.setAttr('y', d))
					: ((e = a), (d = 0), (f = b - a), (h = this.height + 1), (k = b - a), c.setAttr('x', e), c.setAttr('width', k))
		...
		update: function () {
			...
			if (k) {
				...
				if (this.resizingRight) {
					if (m)
						if (
							((a = n - e), !isNaN(this.maxHeight) && a > this.maxHeight && (a = this.maxHeight), a + e > p + f && (a = p - e + f), 0 > a)
						)
		...
		updateDragIconPositions: function () {
			...
			this.rotate
				? ((f = this.dragIconWidth),
				  ...
				  d.translate((k - h) / 2, c + a.height - f / 2))
		...
		handleBgClick: function () {
			...
			if (!a.resizingRight && !a.resizingLeft) {
				...
				m
					...
					: ((b = 'x'), (c = c.mouseX - h / 2 - l), (c = d.fitToBounds(c, 0, a.width - h)))
				a.updateOnReleaseOnly
					? ((a.skipEvent = !1), g.setAttr(b, c), a.dispatchScrollbarEvent(), a.clipDragger())
					: ((a.animating = !0),
					  (c = Math.round(c)),
			...
			if (this.categoryAxis && 'ValueAxis' == this.categoryAxis.cname) d.ChartScrollbar.base.dispatchScrollbarEvent.call(this)
				...
				if (k.parseDates && !k.equalSpacing) {
					if (
						...
						k > b && (k = b),
						0 < e && b - k < e && ((b = Math.round(k + (b - k) / 2)), (g = Math.round(e / 2)), (k = b - g), (b += g), (g = !0)),
						0 < m && b - k > m && ((b = Math.round(k + (b - k) / 2)), (g = Math.round(m / 2)), (k = b - g), (b += g), (g = !0)),
						b > a && (b = a),
						b - e < k && (k = b - e),
						k < h && (k = h),
						k + e > b && (b = k + e),
					...
					if (e != this.start || this.end != b)
						k.startOnAxis && (this.resizingRight && e == b && b++, this.resizingLeft && e == b && (0 < e ? e-- : (b = 1))),
							b == a.length && (b = a.length - 1),
							e == b && b == a.length - 1 && (e = b - 1),
							(this.start = e),
		...
		zoomScrollbar: function (a) {
			if ((!(this.dragging || this.resizingLeft || this.resizingRight || this.animating) || a) && this.dragger && this.enabled) {
				...
				g.parseDates && !g.equalSpacing
					? ((a = g.stepWidth), (c = d.firstTime), (b = a * (this.startTime - c)), (c = a * (this.endTime - c)))
			...
			if (!isNaN(a)) {
				...
				if (this.show) {
					...
					'H' != x
						...
						: (2 * z > A && (z = A / 2),
						  (y = b - A / 2),
						  a < h + (l - h) / 2 ? ((D = a + z), (this.deltaSignX = -1)) : ((D = a - C - z), (this.deltaSignX = 1)))
					y + A >= m && (y = m - A)
					y < k && (y = k)
					D < h && (D = h)
					D + C > l && (D = l - C)
					...
					this.drop
						...
						: 0 < u || 0 === z
						? (0 < M && ((a = d.rect(g, C, A, q, 0, r + 1, P, M, u)), d.isModern ? a.translate(1, 1) : a.translate(4, 4), f.push(a)),
						...
						: ((t = []),
						  ...
						  0 < M && ((a = d.polygon(g, t, u, q, 0, r, P, M)), a.translate(1, 1), f.push(a)),
		...
		processValues: function (a, b, c) {
			...
			for (var h = 'value error open close low high'.split(' '), k = 0; k < h.length; k++) {
				...
				null !== m &&
					((g = Number(m)),
					isNaN(g) || (e[l] = g),
					'date' == b.valueAxis.type && void 0 !== m && ((g = d.getDate(m, b.chart.dataDateFormat)), (e[l] = g.getTime())))
			}
			return e
		},
		...
		processGuides: function () {
			...
			if (a)
				for (var c = 0; c < a.length; c++) {
					...
					var g = e.valueAxis
					g
						? (d.isString(g) && (g = this.getValueAxisById(g)), g ? g.addGuide(e) : this.valueAxes[0].addGuide(e))
	...
	d.TrendLine = d.Class({
		...
		draw: function () {
			...
			k &&
				...
				n && ((n = d.getDate(n, A, 'fff')), (a.finalDate = n), (g = k.dateToCoordinate(n))),
...
;(function () {
	...
	d.handDrawnLine = function (a, b, c, e, g, f, h, k, l, m) {
		...
		for (n = 1; n < b.length; n++)
			for (
				var p = [b[n - 1], b[n]], t = [c[n - 1], c[n]], t = d.makeHD(p, t, a.handDrawScatter), p = t[0], t = t[1], r = 1;
				r < p.length;
				r++
			)
				q.push(
	...
	d.wedge = function (a, b, c, e, g, f, h, k, l, m, n, q, p, t) {
		...
		var u = (1 / 180) * Math.PI,
			...
			H = { fill: d.adjustLuminosity(m.fill, -0.2), 'stroke-opacity': 0, 'fill-opacity': m['fill-opacity'] },
			Q = 0
		180 < Math.abs(g) && (Q = 1)
		e = a.set()
		var M
		...
		if (0 < l) {
			...
			z
				? (M ||
						(P +=
							' A' + (b - f) + ',' + (l + c - h) + ',' + (b + f) + ',' + (l + c + h) + ',' + y + ',' + (B + l) + ',' + D + ',' + (C + l)),
				  (P += ' L' + I + ',' + (u + l)),
				  0 < k &&
						(M ||
							(P +=
		...
		z
			? (M || (g = ' A' + r(b - f) + ',' + r(c - h) + ',' + r(b + f) + ',' + r(c + h) + ',' + r(y) + ',' + r(B) + ',' + r(D) + ',' + r(C)),
			  (h = ' M' + r(x) + ',' + r(A) + ' L' + r(y) + ',' + r(B) + g + ' L' + r(I) + ',' + r(u)))
			: (h = ' M' + x + ',' + A + ' L' + y + ',' + B + (' A' + f + ',' + h + ',0,' + Q + ',1,' + D + ',' + C) + ' L' + I + ',' + u)
		0 < k &&
			(z
				? M || (h += ' B' + (b - k) + ',' + (c - w) + ',' + (b + k) + ',' + (c + w) + ',' + I + ',' + u + ',' + x + ',' + A)
				: (h += ' A' + k + ',' + w + ',0,' + Q + ',0,' + x + ',' + A))
		a.handDrawn &&
	...
	d.Bezier = d.Class({
		construct: function (a, b, c, e, g, f, h, k, l, m, n) {
			...
			for (l = 0; l < b.length; l++)
				isNaN(b[l]) || isNaN(c[l])
					? ((e += this.drawSegment(g, p, t)), l < b.length - 1 && (e += 'L' + b[l + 1] + ',' + c[l + 1] + ' '), (g = []))
			...
			if (2 < a.length)
				for (var g = 0; g < a.length - 1; g++) {
					...
					0 === g
						...
						: g >= a.length - 2
						? (f.push({ x: h.x, y: h.y }), f.push({ x: k.x, y: k.y }), f.push({ x: l.x, y: l.y }), f.push({ x: l.x, y: l.y }))
						: (f.push({ x: h.x, y: h.y }), f.push({ x: k.x, y: k.y }), f.push({ x: l.x, y: l.y }), f.push({ x: m.x, y: m.y }))
					h = []
					k = Math.round
...
;(function () {
	...
	d.VMLRenderer = d.Class({
			...
			if (void 0 !== c) {
				...
				'text' == f &&
					('text-anchor' == b &&
						...
						'middle' == c && ((h.marginLeft = -(k / 2) + 'px'), (h.textAlign = 'center')),
		...
		clipRect: function (a, b, c, d, g) {
			a = a.node
			0 === b && 0 === c
				? ((a.style.width = d + 'px'), (a.style.height = g + 'px'), (a.style.overflow = 'hidden'))
				: (a.style.clip = 'rect(' + c + 'px ' + (b + d) + 'px ' + (c + g) + 'px ' + b + 'px)')
		},
...
;(function () {
	...
	d.AmLegend = d.Class({
		...
		drawLegend: function () {
			...
			this.divWidth = c
			;(b = this.container)
				? ((b.container.innerHTML = ''), f.appendChild(b.container), (b.width = c), (b.height = g), b.setSize(c, g), b.addDefs(a))
		...
		arrangeEntries: function () {
			...
			l = u.height + 2 * m - 1
			'left' == a || 'right' == a
				? ((n = u.width + 2 * f), (k = n + b + c), (h.style.width = k + 'px'), (this.ieW = k))
				: (n = k - b - c - 1)
			c = d.polygon(
				this.container,
				[0, n, n, 0],
		...
		createEntry: function (a) {
			if (!1 !== a.visibleInLegend && !a.hideFromLegend) {
					...
					if ('line' == e || 'step' == e || 'smoothedLine' == e || 'ohlc' == e)
						(m = q.set()),
							...
							a.bullet &&
								...
								(d.setCN(c, t, 'graph-bullet'), t.translate(p + 1, p / 2), m.push(t)),
							(w = 0),
							(t = p),
							(r = p / 3)
					else {
				...
				k &&
					'none' != k &&
					0 < p &&
					('x' == k ? ((x = b.createX()), x.translate(p / 2, p / 2)) : (x = b.createV()),
					(x.dItem = a),
				...
				l = b.fontSize
				m &&
					(p <= l && ((p = p / 2 + b.ly - l / 2 + (l + 2 - p) / 2 - r), m.translate(w, p), x && x.translate(x.x, p)),
...
;(function () {
	...
	d.formatDate = function (a, b, c) {
		...
		0 === r &&
			((r = 24),
			-1 != b.indexOf('H') &&
				(f--, 0 === f && ((e = new Date(a)), e.setDate(e.getDate() - 1), (g = e.getMonth()), (f = e.getDate()), (e = e.getFullYear()))))
		a = g + 1
		9 > g && (a = '0' + a)
		q = f
		10 > f && (q = '0' + f)
