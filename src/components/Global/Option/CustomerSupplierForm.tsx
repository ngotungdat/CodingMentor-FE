...
const CustomerSupplier = (props) => {
	...
	return (
		<>
			...
			{/*  */}
			<Modal
				title={<>{props.showAdd ? 'Thêm Nguồn Khách Hàng' : 'Cập Nhật Nguồn Khách Hàng'}</>}
					...
					<Form form={form} layout="vertical" onFinish={onSubmit}>
						<div className="row">
							<div className="col-12">
								...
								>
									<Input className="style-input" onChange={(e) => setValue('SourceInformationName', e.target.value)} allowClear={true} />
								</Form.Item>
							</div>
						</div>
						<div className="row ">
