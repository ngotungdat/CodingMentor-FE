										...
										userInformation?.RoleID == 2 && (
											<>
												...
												<Popover
													...
													trigger="hover"
												>
													<DoneMarkingExam type="homework" isMarked={isMarked} onDoneMarking={() => setParams({ ...params })} />
												</Popover>
											</>
										)
									) : (
											...
											<>
												{detailResult?.map((item, index) => {
													if (item.ExerciseGroupID !== 0) {
														...
														return (
															<div key={index}>
																<ListQuestion showScore={true} isMarked={isMarked} dataQuestion={item} listQuestionID={listQuestionID} />
															</div>
														)
													}
												})}
