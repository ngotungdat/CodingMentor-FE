...
const MeetingStaff = () => {
	...
	return (
		<>
			...
			{/*  */}
			<Modal title="Danh sách người tham gia" visible={isModalVisible} onCancel={() => setIsModalVisible(false)} footer={null}>
						...
						renderItem={(item) => (
							<List.Item>
								<List.Item.Meta
									...
									title={<a href="https://app-echinese.monamedia.net/Admin/ZoomMeeting/MeetingInternal">{item.title}</a>}
