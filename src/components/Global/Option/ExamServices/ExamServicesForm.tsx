import { DatePicker, Form, Input, Modal, Select, Spin, TimePicker, Tooltip } from 'antd'
					...
					<Form form={form} layout="vertical" onFinish={onSubmit}>
						<div className="row">
							<div className="col-12">
								<Form.Item name="ServicesID" label="Dịch vụ" rules={[{ required: true, message: 'Vui lòng điền đủ thông tin!' }]}>
						...
						<div className="row">
							<div className="col-12">
								<Form.Item name="DayOfExam" label="Ngày thi" rules={[{ required: true, message: 'Vui lòng điền đủ thông tin!' }]}>
						...
						<div className="row">
							<div className="col-12">
								<Form.Item name="Amount" label="Số lượng thí sinh" rules={[{ required: true, message: 'Vui lòng điền đủ thông tin!' }]}>
									<Input
						...
						<div className="row">
							<div className="col-12">
								<Form.Item name="InitialPrice" label="Giá vốn" rules={[{ required: true, message: 'Vui lòng điền đủ thông tin!' }]}>
									<Input
						...
						<div className="row">
							<div className="col-12">
								<Form.Item name="Price" label="Giá bán" rules={[{ required: true, message: 'Vui lòng điền đủ thông tin!' }]}>
									<Input
