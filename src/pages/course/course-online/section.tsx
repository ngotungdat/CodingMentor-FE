...
const SectionListing = () => {
	...
	return (
		<>
				...
				<div className="col-12">
					...
					<div className="wrap-table">
						<Card
							...
							extra={<Search placeholder="Khóa học" onSearch={onSearch} className="btn-search" size="large" />}
						>
			...
			<AddSection visible={addSection} onCancel={() => setAddSection(false)}></AddSection>
		</>
	)
}
