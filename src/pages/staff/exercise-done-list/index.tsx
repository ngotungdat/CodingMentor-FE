		...
		return (
			<>
				<div className="feedback-detail-text">
					Bài tập trong thời gian nghỉ: Paraphrase các câu sau (thử nhiều cách nhé, ít nhất hai cách): 1. There will be a few changes in the
					office. 2. You weren't careful, so you made many mistakes. 3. He seems very well-educated, however, he is not very bright. 4. He
					drank a cup of tea. He felt dizzy afterwards. 5. She loves watching rom-com. Her brother loves it, too. 6. He said that it was
					Mary who had stolen the money.
				</div>
			</>
		)
	}
