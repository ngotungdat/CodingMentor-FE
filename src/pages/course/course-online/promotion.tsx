				...
				<div className="col-12">
					...
					<div className="wrap-table">
						<Card
							...
							extra={<Search placeholder="Mã khuyến mãi" onSearch={onSearch} style={{ width: 250 }} className="btn-search" size="large" />}
						>
							<PowerTable columns={columns} dataSource={data} />
							<AddPromotion visible={addPromotion} onCancel={() => setAddPromotion(false)} />
						</Card>
					</div>
				</div>
			</div>
