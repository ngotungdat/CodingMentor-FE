			...
			<Form layout="vertical" onFinish={form.handleSubmit(checkHandleFilter)}>
				<div className="row">
					<div className="col-md-12">
						<DateField form={form} name="fromDate" label="Ngày học từ" placeholder="Chọn ngày" />
					</div>
					<div className="col-md-12">
...
ZoomRoomFilter.propTypes = {
	handleFilter: PropTypes.func,
	handleResetFilter: PropTypes.func
}
ZoomRoomFilter.defaultProps = {
	handleFilter: null,
	handleResetFilter: null
}
export default ZoomRoomFilter
