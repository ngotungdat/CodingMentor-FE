...
import { districtApi, studentAdviseApi, studentApi, wardApi } from '~/apiBase'
						...
						<Skeleton loading={loadingCustomer}>
							<Form layout="vertical" onFinish={form.handleSubmit(onSubmit)}>
								<div className="row">
									...
									<div className="col-md-6 col-12">
										<InputTextField form={form} name="ChineseName" label="Tên tiếng Trung" placeholder="Nhập tên tiếng Trung" />
									</div>
									{/*  */}
									<div className="col-md-6 col-12">
