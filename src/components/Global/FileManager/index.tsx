...
const FileManagerForm = (props) => {
	...
	return (
		<>
			{/* @ts-ignore */}
			<FileManager fileSystemProvider={props.fileItems} customizeThumbnail={customizeIcon} height={750} onOptionChanged={onOptionChanged}>
				<ItemView mode={itemViewMode}></ItemView>
				<Permissions create={true} copy={true} move={true} delete={true} rename={true} upload={true} download={true}></Permissions>
			</FileManager>
		</>
	)
}
