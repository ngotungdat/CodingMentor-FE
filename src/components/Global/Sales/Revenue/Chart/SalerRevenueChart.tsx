...
function SalerRevenueChart(props) {
	...
	return (
		<Card title={<h4>BIỂU ĐỒ TỔNG KẾT DOANH THU</h4>} style={{ borderRadius: 20 }}>
			<ResponsiveContainer width="100%" height={280}>
				<ComposedChart data={revenueList} margin={{ top: 10, right: 0, left: 40, bottom: 0 }}>
					...
					<Bar dataKey="CustomersNumber" name="Số khách hàng" barSize={20} fill="#003366" stackId="col" />
					<Bar dataKey="InvoiceNumber" name="Số hóa đơn" barSize={20} fill="#0080FF" stackId="col" />
					<Bar dataKey="Revenue" name="Doanh thu theo chiến dịch" barSize={20} fill={_.primaryColor} stackId="col" />
				</ComposedChart>
			</ResponsiveContainer>
		</Card>
	)
