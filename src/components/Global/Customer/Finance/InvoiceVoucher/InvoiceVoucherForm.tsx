...
function InvoiceVoucherForm(props) {
	...
	return (
		<>
			...
			<Modal title={title} visible={isModalVisible} onCancel={closeModal} footer={null}>
				<div className="wrap-form">
					<Form layout="vertical" onFinish={form.handleSubmit(checkHandleSubmit)}>
						<div className="row mb-5">
							<div className="col-12">
								<TextAreaField form={form} name="Reason" label="Lý do" rows={5} placeholder="Nhập lý do" />
							</div>
						</div>
						<div className="row">
							<div className="col-12">
								<button type="submit" className="btn btn-primary w-100 mt-3" disabled={isLoading.type === 'ADD_DATA' && isLoading.status}>
									Lưu
