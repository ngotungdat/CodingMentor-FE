			...
			<div className="row">
				<div className="col-12">
					...
					<div className="wrap-table">
						<Card className="cardRadius" extra={<Search placeholder="Tìm kiếm" className="btn-search" size="large" />}>
							<Table bordered columns={columns} dataSource={data} scroll={{ x: 2000 }} sticky />
						</Card>
					</div>
				</div>
			</div>
