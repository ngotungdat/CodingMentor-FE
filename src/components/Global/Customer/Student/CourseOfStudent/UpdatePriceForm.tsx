import { Button, DatePicker, Form, Input, Modal, Radio, Spin, Tooltip } from 'antd'
					...
					<div className="row">
						...
						<div className="col-12 col-md-6">
							<Form.Item name="PayDate" label="Ngày hẹn thanh toán">
								<DatePicker name="PayDate" className="style-input w-100" placeholder="Ngày hẹn thanh toán" format="YYYY/MM/DD" />
							</Form.Item>
						</div>
						<div className="col-12">
