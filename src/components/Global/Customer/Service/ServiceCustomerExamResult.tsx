			...
			<Modal title="Cập nhật lại điểm" visible={isModalVisible} onCancel={() => setIsModalVisible(false)} footer={null}>
				<div className="container-fluid">
					<Form form={form} layout="vertical" onFinish={onSubmit}>
						...
						<div className="row">
							<div className="col-6">
								<Form.Item label="Ngày thị" name="Ngày thị" initialValue={moment(props.rowData?.DayOfExam).format('DD/MM/YYYY')}>
									<Input className="style-input" readOnly={true} />
								</Form.Item>
							</div>
							<div className="col-6">
								<Form.Item label="Số kỹ năng" name="Số kỹ năng" initialValue={props.rowData?.Skills}>
									<InputNumber className="ant-input w-100 style-input" min={1} max={4} onChange={(value) => setValue('Skills', value)} />
								</Form.Item>
							</div>
						</div>
						<div className="row">
							<div className="col-6">
								...
								>
									<InputNumber className="ant-input w-100 style-input" onChange={(value) => setValue('ListeningPoint', value)} />
								</Form.Item>
							</div>
							<div className="col-6">
								<Form.Item label="Speaking" name="Speaking" initialValue={props.rowData?.SpeakingPoint}>
									<InputNumber className="ant-input w-100 style-input" onChange={(value) => setValue('SpeakingPoint', value)} />
								</Form.Item>
							</div>
						</div>
						<div className="row">
							<div className="col-6">
								<Form.Item label="Reading" name="Reading" initialValue={props.rowData?.ReadingPoint}>
									<InputNumber className="ant-input w-100 style-input" onChange={(value) => setValue('ReadingPoint', value)} />
								</Form.Item>
							</div>
							<div className="col-6">
								<Form.Item label="Writing" name="Writing" initialValue={props.rowData?.WritingPoint}>
									<InputNumber className="ant-input w-100 style-input" onChange={(value) => setValue('WritingPoint', value)} />
								</Form.Item>
							</div>
						</div>
						<div className="row ">
