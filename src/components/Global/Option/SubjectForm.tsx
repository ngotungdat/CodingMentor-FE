...
const SubjectForm = React.memo((props: any) => {
	...
	return (
		<>
			...
			<Modal title={rowID ? 'Sửa môn học' : 'Tạo bài học'} visible={isModalVisible} onCancel={() => setIsModalVisible(false)} footer={null}>
				<div className="container-fluid">
					<Form form={form} onFinish={onSubmit} layout="vertical">
						<div className="row">
							<div className="col-12">
								<Form.Item label="Chương trình" name="ProGramID" rules={[{ required: true, message: 'Bạn không được để trống' }]}>
									<Select
										disabled={true}
										style={{ width: '100%' }}
						...
						<div className="row">
							<div className="col-12">
								<Form.Item label="Tên bài học" name="SubjectName" rules={[{ required: true, message: 'Bạn không được để trống' }]}>
									<Input placeholder="" className="style-input" onChange={(e) => setValue('SubjectName', e.target.value)} />
								</Form.Item>
							</div>
						</div>
