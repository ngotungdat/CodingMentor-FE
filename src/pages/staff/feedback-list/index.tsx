		...
		return (
			<>
				<div className="feedback-detail-text">
					Dương Lan Anh Advance1412. Buổi nghỉ: tối 02/03/2021 (writìng) và 03/03/2021(speaking) Lý do: Em đang ở vùng dịch ạ (thị xã Kinh
					Môn, huyện Kinh Môn, tỉnh Hải Dương)
				</div>
			</>
		)
	}
