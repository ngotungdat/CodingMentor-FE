...
import { payFixListApi, priceFixExamApi, studentApi } from '~/apiBase'
...
const PayFixList = (props) => {
	...
	const columnsStudent = [
		...
		},
		{
			...
			render: (type) => {
				return <>{type ? <span className="tag yellow">Đang chờ duyệt</span> : <span className="tag green">Đã duyệt tất cả</span>}</>
			}
		}
	]
